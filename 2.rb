arr = ['ayitmcjvlhedbsyoqfzukjpxwt',
...
arr.each do |id|
  multiples = id.chars.map { |c| id.chars.count(c) }.uniq
  twice_count += 1 if multiples.include?(2)
  thrice_count += 1 if multiples.include?(3)
end

puts twice_count * thrice_count
